...
int LaunchWithHacks()
{
	const std::wstring exe_path = L"C:\\Users\\kphelps\\Downloads\\World of Warcraft 1.12\\WoW.exe";
	const std::wstring work_dir = L"C:\\Users\\kphelps\\Downloads\\World of Warcraft 1.12";
